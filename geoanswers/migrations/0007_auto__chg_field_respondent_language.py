...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Respondent.language'
        db.alter_column('geoanswers_respondent', 'language', self.gf('django.db.models.fields.CharField')(null=True, max_length=2))

    def backwards(self, orm):

        # Changing field 'Respondent.language'
        db.alter_column('geoanswers_respondent', 'language', self.gf('django.db.models.fields.CharField')(max_length=2, default=None))
    ...
    models = {
        ...
        'munigeo.administrativedivision': {
            ...
            'name_fi': ('django.db.models.fields.CharField', [], {'null': 'True', 'db_index': 'True', 'max_length': '50'}),
            'name_sv': ('django.db.models.fields.CharField', [], {'null': 'True', 'db_index': 'True', 'max_length': '50'}),
