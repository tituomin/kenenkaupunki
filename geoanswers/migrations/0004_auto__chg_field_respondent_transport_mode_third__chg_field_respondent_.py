...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('geoanswers_respondent', 'transport_mode_third', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Respondent.transport_mode_second'
        db.alter_column('geoanswers_respondent', 'transport_mode_second', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Respondent.nonlocal_home'
        db.alter_column('geoanswers_respondent', 'nonlocal_home', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Respondent.life_situation'
        db.alter_column('geoanswers_respondent', 'life_situation', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Respondent.transport_mode_first'
        db.alter_column('geoanswers_respondent', 'transport_mode_first', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Respondent.transport_mode_third'
        db.alter_column('geoanswers_respondent', 'transport_mode_third', self.gf('django.db.models.fields.CharField')(max_length=20, default=None))

        # Changing field 'Respondent.transport_mode_second'
        db.alter_column('geoanswers_respondent', 'transport_mode_second', self.gf('django.db.models.fields.CharField')(max_length=20, default=None))

        # Changing field 'Respondent.nonlocal_home'
        db.alter_column('geoanswers_respondent', 'nonlocal_home', self.gf('django.db.models.fields.CharField')(max_length=200, default=None))

        # Changing field 'Respondent.life_situation'
        db.alter_column('geoanswers_respondent', 'life_situation', self.gf('django.db.models.fields.CharField')(max_length=200, default=None))

        # Changing field 'Respondent.transport_mode_first'
        db.alter_column('geoanswers_respondent', 'transport_mode_first', self.gf('django.db.models.fields.CharField')(max_length=20, default=None))
    ...
    models = {
        'geoanswers.respondent': {
            ...
            'transport_mode_first': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'transport_mode_second': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'transport_mode_third': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'})
        },
