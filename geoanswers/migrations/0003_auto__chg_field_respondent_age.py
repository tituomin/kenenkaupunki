...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Respondent.age'
        db.alter_column('geoanswers_respondent', 'age', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Respondent.age'
        db.alter_column('geoanswers_respondent', 'age', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
    ...
    models = {
        ...
        'munigeo.administrativedivision': {
            ...
            'ocd_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True', 'unique': 'True', 'null': 'True'}),
